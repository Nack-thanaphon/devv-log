...
<body id="page-top">
                    ...
                    <div class="col-12 m-0 p-0 border">
                        ...
                        <form id="formData">
                            <div class="card-body">
                                ...
                                <button type="submit" id="news_save" class="btn btn-primary btn-block mx-auto w-75">บันทึกข้อมูล</button>
                            </div>
                        </form>
    ...
    <script>
        $(function() {
            $('#news_save').click(function(e) { // เรียกใช้งาน เพิ่มข้อมูล (สำคัญ)
                let name = $("#name").val();
                let image = $("#image").val();
                let date = $("#date").val();
                ...
                if (datail == "") {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "../services/news/ck_create.php",
