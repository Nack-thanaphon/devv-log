            ...
            <div class="row">
                <div class="col-sm-6 login-section-wrapper">
                    <div class="brand-wrapper">
                        <h1 class="text-uppercase">Dev-Log</h1>
                        <h4 class="">It just stupid Blog.Nothing Here.</h4>
                    </div>
                    <div class="login-wrapper my-auto">
                        ...
                        <form>
                            <div class="form-group">
                                <label for="name" class="text-uppercase">My email</label>
                                <input type="text" name="user_email" id="useremail" class="form-control" placeholder="Please Press Email">
                                <!-- <small id="messageName" class="text-danger">Your name is mandatory.</small> -->
                            </div>
                            <div class="form-group mb-4">
                                <label for="pass" class="text-uppercase">My Password</label>
                                <input type="password" name="user_password" id="password" class="form-control" placeholder="Please Press Password">
